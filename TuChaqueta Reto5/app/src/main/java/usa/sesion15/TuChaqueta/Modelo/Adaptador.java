...
public class Adaptador extends BaseAdapter {
    ...
    /*
    Asignación del item y lo elementos y valores a cada item.
     */
    @Override
    public View getView(int posicion, View v, ViewGroup viewGroup) {
        ...
        String rutaimagen = datosItem.getImagen();
        Picasso.get().load(rutaimagen).fit().error(R.mipmap.iconotuch_foreground).into(imagen);
        ...
        boton1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(context, "Favorito Agregado", Toast.LENGTH_LONG).show();
         ...
         */
        //imagen.setText(datosItem.getImagen());
